...
/* Get last 10 records - descending result - simpler approach*/
select *
from bear.timeseries
...
/* Get last 10 records - ascending result - simpler approach*/
select * order by datex ASC, timex ASC
from bear.timeseries
qualify rank(datex, timex) <= 10;  /* get ranks top 10 after descending sort by datex/timex */
...
/* get last 10% of records - descending result - simpler approach*/
select *
from bear.timeseries
