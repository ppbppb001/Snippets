# ---------------------------------------------
# <economics-match-lib-test.r>
#   Test/Example programme demos how to 
#   use <economics-match-lib.r> code module
#
# [2017-06-30]
# ----------------------------------------------
...
source("economics-match-lib.r")   # Load and run external code module
...
df.new <- matchEconomics(data = target.df, 
                         datename = "Date",
...
matchEconomics()    # call 'matchEconomics()' without any input to
                    # create the global lookup table only

print(head(lookup.Economics))  # check content of global lookup table
print(tail(lookup.Economics))  # check content of global lookup table
