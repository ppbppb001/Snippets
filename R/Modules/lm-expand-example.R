...
# 'train' - training data :
train.base <- retrieveGlmMeasures(measures, "base", "train")
head(train.base[[1]])    # display sample of base-iteration-1
train.ext <- retrieveGlmMeasures(measures, "extend", "train")
head(train.ext[[1]])     # display sample of ext-iteration-1

# 'test' - testing data :
test.base <- retrieveGlmMeasures(measures, "base", "test")
head(test.base[[1]])
test.ext <- retrieveGlmMeasures(measures, "extend", "test")
head(test.ext[[1]])
